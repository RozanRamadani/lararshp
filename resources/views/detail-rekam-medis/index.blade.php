<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Back Button -->
            <div class="mb-6">
                <a href="{{ auth()->user()->hasRole('Dokter') ? route('dokter.rekam-medis.show', ['rekamMedis' => $rekamMedis->idrekam_medis]) : route('perawat.rekam-medis.show', ['rekam_medi' => $rekamMedis->idrekam_medis]) }}"
