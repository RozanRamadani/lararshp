                                ...
                                @if($selectedPet)
                                    <div class="mt-4 p-4 bg-gray-50 rounded-md">
                                        ...
                                        <div class="space-y-1 text-sm text-gray-600">
                                            <p><strong>Species:</strong> {{ $selectedPet->jenis_hewan->nama_jenis ?? '-' }}</p>
                                            <p><strong>Breed:</strong> {{ $selectedPet->ras_hewan->nama_ras ?? '-' }}</p>
                                            <p><strong>Gender:</strong> {{ $selectedPet->jenis_kelamin ?? '-' }}</p>
                                            <p><strong>Owner:</strong> {{ $selectedPet->pemilik->nama ?? '-' }}</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" id="tanggal_kunjungan" name="tanggal_kunjungan" value="{{ old('tanggal_kunjungan', date('Y-m-d')) }}" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="dalam_perawatan" {{ old('status') == 'dalam_perawatan' ? 'selected' : '' }}>Dalam Perawatan</option>
                                        <option value="selesai" {{ old('status') == 'selesai' ? 'selected' : '' }}>Selesai</option>
                                        <option value="rujukan" {{ old('status') == 'rujukan' ? 'selected' : '' }}>Rujukan</option>
                                    </select>
                                    @error('status')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input type="number" id="suhu" name="suhu" value="{{ old('suhu') }}" step="0.01" min="0" max="99.99" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="38.5">
                                        @error('suhu')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="berat_badan" name="berat_badan" value="{{ old('berat_badan') }}" min="0" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="5">
                                        @error('berat_badan')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="anamnesa" name="anamnesa" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Keluhan utama dan riwayat penyakit...">{{ old('anamnesa') }}</textarea>
                                    @error('anamnesa')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="pemeriksaan_fisik" name="pemeriksaan_fisik" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Hasil pemeriksaan fisik...">{{ old('pemeriksaan_fisik') }}</textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="diagnosis" name="diagnosis" rows="2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Diagnosis penyakit...">{{ old('diagnosis') }}</textarea>
                                    @error('diagnosis')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="tindakan" name="tindakan" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Tindakan medis yang dilakukan...">{{ old('tindakan') }}</textarea>
                                    @error('tindakan')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="resep_obat" name="resep_obat" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Resep obat dan dosis...">{{ old('resep_obat') }}</textarea>
                                    @error('resep_obat')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" id="tanggal_kontrol" name="tanggal_kontrol" value="{{ old('tanggal_kontrol') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="catatan" name="catatan" rows="2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Catatan tambahan...">{{ old('catatan') }}</textarea>
                                    @error('catatan')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
