    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.perawat.update', $perawat->iduser) }}">
                        @csrf
                        @method('PUT')

                        <div class="mb-4">
                            <label for="nama" class="block text-sm font-medium text-gray-700">Nama Lengkap *</label>
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $perawat->nama) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $perawat->email) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="no_wa" id="no_wa" value="{{ old('no_wa', $perawat->no_wa) }}"
                        ...
                        <hr class="my-6">
                        <h3 class="text-lg font-semibold mb-4 text-gray-800">Informasi Profil Perawat</h3>

                        <div class="mb-4">
                            <label for="alamat" class="block text-sm font-medium text-gray-700">Alamat *</label>
                            <textarea name="alamat" id="alamat" rows="3" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">{{ old('alamat', $perawat->perawat->alamat ?? '') }}</textarea>
                            @error('alamat')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $perawat->perawat->no_hp ?? '') }}" required
                                placeholder="contoh: 081234567890"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            @error('no_hp')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="pendidikan" id="pendidikan" value="{{ old('pendidikan', $perawat->perawat->pendidikan ?? '') }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center space-x-4">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin', $perawat->perawat->jenis_kelamin ?? '') == 'L' ? 'checked' : '' }} required
                                ...
                                <label class="inline-flex items-center">
                                    <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin', $perawat->perawat->jenis_kelamin ?? '') == 'P' ? 'checked' : '' }} required
                                        class="rounded-full border-gray-300 text-teal-600 shadow-sm focus:border-teal-300 focus:ring focus:ring-teal-200 focus:ring-opacity-50">
