            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.dokter.store') }}">
                        ...
                        <!-- Pilih User -->
                        <div class="mb-4">
                            <label for="id_user" class="block text-sm font-medium text-gray-700">Pilih User (Dokter) *</label>
                            ...
                            @enderror
                            @if($users->isEmpty())
                                <p class="mt-1 text-sm text-amber-600">Tidak ada user dengan role Dokter yang belum memiliki profil.</p>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="bidang_dokter" id="bidang_dokter" value="{{ old('bidang_dokter') }}" required
                                placeholder="contoh: Umum, Spesialis Hewan Kecil, dll"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            @error('bidang_dokter')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
