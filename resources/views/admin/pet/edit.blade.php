                ...
                <div class="p-6">
                    <form method="POST" action="{{ request()->routeIs('resepsionis.pet.*') ? route('resepsionis.pet.update', $pet->idpet) : route('admin.pet.update', $pet->idpet) }}">
                        ...
                        <div class="flex items-center justify-end space-x-3 mt-6">
                            <a href="{{ request()->routeIs('resepsionis.pet.*') ? route('resepsionis.pet.index') : route('admin.pet.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 focus:bg-gray-400 active:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Batal
                            </a>
